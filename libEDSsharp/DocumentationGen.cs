...
This file was automatically generated by a modified [CANopenEditor](https://github.com/CANopenNode/CANopenEditor) {8}
...
| Transmission | {3,-62}|",
        ...
        {
            var count_label = od.prop.CO_countLabel;
            if (count_label == null || count_label == "")
                count_label = "Not defined";

            var storage_group = od.prop.CO_storageGroup;
            if (storage_group == null || storage_group == "")
                storage_group = "Not defined";
...
| ---- | --------------------- | ---------- | --- | --- | ---- | ------------- |"));
                ...
                foreach (ODentry subod in od.subobjects.Values)
                {
                    var description_sub = subod.Description;
                    if (description_sub == null || description_sub == "")
                        description_sub = "*No description*";

                    file.WriteLine(string.Format(@"
**{0}** [0x{2:X2}]  
{1}
", subod.parameter_name,
        description_sub.Replace("\n", "  \n"),
        subod.Subindex,
        PrintDataType(subod)));
